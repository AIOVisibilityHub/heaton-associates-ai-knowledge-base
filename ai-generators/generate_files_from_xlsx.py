...
#
# Also normalizes a few columns so build_public_pages.py can render consistently:
...
def ensure_unique_path(output_dir: str, base_slug: str, ext: str) -> str:
    """Create a unique path in output_dir for base_slug + ext by appending -N if needed."""
...
def main(input_file="templates/AI-Visibility-Master-Template.xlsx"):
    ...
    for actual_sheet in xlsx.sheet_names:
        ...
        if canon == "help_articles":
            for idx, row in df.iterrows():
                ...
                path = ensure_unique_path(output_dir, slug, ".md")
        ...
        if canon == "faqs":
            for idx, row in df.iterrows():
                ...
                path = ensure_unique_path(output_dir, slug, ".json")
    ...
    "description": bio,
        ...
        for idx, row in df.iterrows():
            ...
            path = ensure_unique_path(output_dir, id_field, ".json")
